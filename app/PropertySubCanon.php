...
*/
class PropertySubCanon extends Model 
{
    use SoftDeletes;

  

    protected $table = 'properties_sub_canon';

    protected $fillable = ['id_tenant','id_property_sub','nuevo_canon','observaciones','fecha_cambio'];
