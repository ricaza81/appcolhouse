...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        Mail::send('correo.plantilla_registro_usuario', $data, function ($message) use ($asunto,$id_usuario,$nombre,$email_usuario) {
    ...
    public function processInvitation($invitation_token)
    {
