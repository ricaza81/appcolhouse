...
.m-status-2 {
 ...
 <a href="{{ route('landing.index') }}" class="main-logo"><img src="{{url('css/imagenes/logo-colhouse.png')}}" alt="Colhouse" style="width: 215px;padding-left: 25px;padding-top: 20px;" /></a>

    <h3 class="page-title" style="margin-top:-20px">Informe Propietario: {{$propietario->nombre}}</h3>
