...
@section('content')
    <h3 class="page-title">Crear Propietario</h3>
    {!! Form::open(['method' => 'POST', 'route' => ['admin.properties_propietarios.store']]) !!}
               ...
               <div class="row" style="padding:10px;">
                    <div  style="border:1px solid #000;padding:10px;background-color:#d4edda;margin-bottom:10px;border-radius:5px">Propiedad principal:
                        <h3><b>{{$property->name}}</b></h3>
                         ...
                         <div  style="border:1px solid #000;padding:10px;background-color:#d4edda;margin-bottom:10px;border-radius:5px">
                                <span class="label label-danger" style="padding-bottom:0px;padding-top:8px;font-weight:700;">Valor total arrendamiento:
                                <h4 style="font-weight:700;">${{number_format($property->valor_total_arrendamiento($property->id)), 0, ',', '.'}}</h4>
                                </span>
                                 <span class="label label-danger" style="padding-bottom:0px;padding-top:8px;font-weight:700;">Valor ocupación actual:
                                <h4 style="font-weight:700;">${{ number_format($property->valor_ocupacion_actual($property->id)), 0, ',', '.'}}</h4>
                                </span>
                                  <span class="label label-danger" style="padding-bottom:0px;padding-top:8px;font-weight:700;"># Unidades:
                                <h4 style="font-weight:700;">{{ $property->unidades()->count() }}</h4>
                                </span>
                                 <span class="label label-danger" style="padding-bottom:0px;padding-top:8px;font-weight:700;"># Inquilinos:
                                <h4 style="font-weight:700;">{{ $property->inquilinos()->count() }}</h4>
                                </span>
                          </div>
                ...
                <div class="panel panel-default" style="padding:20px;padding-bottom:0px;">
                    ...
                    <div class="row" style="padding-top:15px;">
                       ...
                       <div class="col-xs-12 form-group">
                                ...
                                {!! Form::textarea('observaciones', old('observaciones'), ['class' => 'form-control','rows' => 1, 'placeholder' => '¿Alguna nota para este propietario?', 'required' => '']) !!}
                                <p class="help-block"></p>
