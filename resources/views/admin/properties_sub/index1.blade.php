...
@section('content')
    ...
    @can('property_create')
    <p>
        <a href="{{ route('admin.properties_sub.create',10) }}" class="btn btn-success">@lang('global.app_add_new')</a>
    </p>
    @endcan
                    ...
                    @if (count($properties) > 0)
                        @foreach ($properties as $property)
                            <tr data-entry-id="{{ $property->id }}">
                                ...
                                <td field-key='tipo'>{{ $property->tipo_propiedad_sub->tipo }}</td>
                                <td field-key='name'>$ {{ $property->renta }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.properties_facturas.facturas_consulta',[$property->id]) }}" class="btn btn-xs btn-warning">Facturas</a>
