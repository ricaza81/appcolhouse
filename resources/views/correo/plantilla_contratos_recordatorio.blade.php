...
<br>
<div class="label label-warning">Por favor actualice la duración de los siguientes contratos.</div>
<br>
<br>

<div align="center" style="background: #eee; color:#000;
    line-height: 6px;
    padding: 20px 20px 20px 20px;border-radius: 8px 8px 8px 8px;width: 90%;margin: auto;"><h2>Inquilinos sin duración de contrato:</h2></div>
    ...
    <thead>
        <tr>
            ...
            <th align="center" scope="col" style="width:20px;padding:20px 20px 20px 20px;border-bottom:3px solid #fff">Duración contrato</th>
        ...
        <?php
            ...
            <tr role="row" class="odd"  >
                ...
                <td align="center" style="width:20px;padding:20px 20px 20px 20px;border-bottom:1px solid #4CAF50;background-color: #fff;color:#4CAF50;"><a href="{{url('https://www.colhouse.com.co/crm/public/admin/tenants/'.$usuario->id)}}">Ver inquilino</a></td>
                 <td align="center" style="width:20px;padding:20px 20px 20px 20px;border-bottom:1px solid #4CAF50;background-color: #fff;color:#4CAF50;">
                   ...
                   <a href="{{url('https://www.colhouse.com.co/crm/public/admin/tenants/'.$usuario->id.'/edit')}}">Crear Duración del contrato ></a>
                    <!--',[$usuario->id]) }}">Editar </a>-->
                 </td>
