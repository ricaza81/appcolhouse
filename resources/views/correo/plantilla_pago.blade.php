...
.m-status-2 {
 ...
 <a href="" class="main-logo"> <img src="{{url('css/imagenes/logo-colhouse.png')}}" alt="ColHouse" width="270"  style="border:0; margin:0; padding:0; display:block;" editable label="image-1"></a>

    <h3 class="page-title" style="margin-top:-20px">Detalles de Transacción # COL-PAGO-{{$factura->pago_valor->id}}</h3>
                    ...
                    <div style="float:left;font-size:14px;width:200px">
                     ...
                     <div style="margin-left:250px;width:400px;font-size:14px">
                        <table>
                            <thead>
                                <tr>
                                   <th align="center" scope="col" style="width:20px;padding:5px;border-bottom:3px solid #fff">Vlr. Factura
                                   </th>
