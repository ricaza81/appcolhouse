...
<div class="" ><h2>Nueva Factura</h2></div>

<div class="div_contenido" ><h3># Factura: COL-FT-<?=$id_factura;?></h3>
<div class="" ><h3>Unidad: <?=$nombre_unidad;?></h3></div>
<div class="" ><h3>A nombre de: <?=$nombre_tenant;?></h3></div>
<div class="" ><h3>Valor arrendamiento: $<?=number_format($valor);?></h3></div>
<div class="" ><h3>Valor Adicionales: $<?=number_format($adicionales);?></h3></div>
<div class="" ><h3>Valor Deducciones: $<?=number_format($deducciones);?></h3></div>
<div class="" ><h3>Fecha Inicio: <?=$fecha_inicio;?></h3></div>
<div class="" ><h3>Fecha Corte: <?=$fecha_corte?></h3></div>
<div class="" ><h3>Valor Facturado Neto: $<?=number_format($valor_neto);?></h3></div>
</div>
