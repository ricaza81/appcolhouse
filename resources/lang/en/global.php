...
return [
	...
	'properties_sub' => [
		'title' => 'SubPropiedades',
		'fields' => [
			'property' => 'Propiedad',
			'nombre' => 'Unidad',
			'tipo_sub' => 'Tipo',
			'metros_cuadrados' => 'M2 Cuadrados',
			'numero_banos' => '# Baños',
			'numero_cocinas' => '# Cocinas',
			'numero_parqueaderos' => '# Parqueaderos',
			'generales' => 'Datos generales',
			'renta' => 'Renta',
			'comision' => '%',
			'photo' => 'Foto',
			'inquilinos' => 'Inquilinos',
			'observaciones' => 'Observaciones / Detalles'
		],
	],
    ...
    'tenants' => [
        ...
        'fields' => [
            ...
            'cedula' => 'Cédula',
            'codeudor' => 'Codeudor',
            'cc_codeudor' => 'Cédula Codeudor',
            'email_codeudor' => 'Email Codeudor',
            'tel_codeudor' => 'Teléfono Codeudor',
            'dir_codeudor' => 'Dirección Codeudor',
            'fechainicio' => 'Fecha Inicio Contrato',
            'valor_pago_pendiente' => 'Por pagar',
	...
	'seguros' => [
		...
		'fields' => [
			...
			'fechafin' => 'Fecha Fin',
			'costo' => 'Costo',
			'cobertura' => 'Millones cobertura',
			'empresa' => 'Empresa Aseguradora',
			'observaciones' => 'Observaciones del Seguro',
		],
	],
	...
	'facturas' => [
		...
		'fields' => [
			...
			'tenant' => 'Inquilino',
			'valor' => 'Valor Factura',
			'valor_neto' => 'Valor Neto Factura',
			'valor_arrendamiento' => 'Valor Arriendo',
			'valor_neto' => 'Valor Neto Factura',
			'fechafactura' => 'Fecha factura',
			'valorpago' => 'Valor Pagado',
			'consultarfactura' => 'Consulta de Factura',
			'fechainicio' => 'Fecha Inicio',
			'fechacorte' => 'Fecha Vencimiento',
			'adicionales' => 'Gastos adicionales',
			'obs_adicionales' => 'Observaciones adicionales',
			'deducciones' => 'Deducciones adicionales',
			'obs_deducibles' => 'Observaciones deducibles',
			'saldo' => 'Saldo',
		],
	],
	...
	'app_reset_password_woops' => '<strong>Whoops!</strong> Hubo problemas con la entrada:',
	...
	'app_register' => 'Crear cuenta',
	'app_registration' => 'Crear cuenta como propietario',
	...
	'app_there_were_problems_with_input' => 'Hubo problemas con los datos',
	'app_whoops' => 'Whoops!',
